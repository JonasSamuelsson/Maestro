...
{
	internal class ConditionalInstanceExpression<TPlugin> : IConditionalInstanceExpression<TPlugin>
	{
		private readonly InstanceRegistrator<TPlugin> _registrator;

		public ConditionalInstanceExpression(InstanceRegistrator<TPlugin> registrator)
		{
